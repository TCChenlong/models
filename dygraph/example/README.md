...
## [四、快速开始](https://github.com/PaddlePaddle/PaddleDetection/blob/release/2.0-rc/docs/tutorials/QUICK_STARTED_cn.md)
...
| 混合精度训练 | [resnet(amp)]() |
| 模型文件 | [ResNet](https://github.com/PaddlePaddle/PaddleDetection/blob/release/2.0-rc/ppdet/modeling/backbones/resnet.py#L39) |
