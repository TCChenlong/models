...
本模型的实现存放于 [PaddleClas](https://github.com/PaddlePaddle/PaddleClas)中，快速开始请参考[快速开始](https://github.com/PaddlePaddle/PaddleClas/blob/release/2.0/docs/en/tutorials/quick_start_en.md),模型源文件地址为 [resnet.py](https://github.com/PaddlePaddle/PaddleClas/blob/release/2.0/ppcls/modeling/architectures/resnet.py#L310)。
...
| 混合精度训练 | [resnet(amp)]() |
| 模型源代码 | [ResNet152](https://github.com/PaddlePaddle/PaddleClas/blob/release/2.0/ppcls/modeling/architectures/resnet.py#L310) |
| 在线运行 | [使用ResNet152实现图像分类]() | 
