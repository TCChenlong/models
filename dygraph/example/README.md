...
| 混合精度训练 | [resnet(amp)]() |
| 模型源代码 | [resnet.py](https://github.com/PaddlePaddle/PaddleDetection/blob/release/2.0-rc/ppdet/modeling/backbones/resnet.py#L39) |
| 在线运行 | [使用ResNet50实现图像分类]() | 

## 六、如何自定义数据集

如果想要在训练时自定义数据集，可以参考这篇文档[如何训练自定义数据集](https://github.com/PaddlePaddle/PaddleDetection/blob/release/2.0-rc/docs/tutorials/Custom_DataSet.md)。